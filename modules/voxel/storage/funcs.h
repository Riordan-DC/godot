...
inline FixedArrayV<uint8_t, 4> decode_weights_from_packed_u16(uint16_t packed_weights) {
...
inline FixedArrayV<uint8_t, 4> decode_indices_from_packed_u16(uint16_t packed_indices) {
...
inline void debug_check_texture_indices(FixedArrayV<uint8_t, 4> indices) {
	FixedArrayV<bool, 16> checked;
	checked.fill(false);
