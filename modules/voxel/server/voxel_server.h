...
public:
	...
	struct BlockMeshInput {
		...
		FixedArrayV<std::shared_ptr<VoxelBufferInternal>, VoxelConstants::MAX_BLOCK_COUNT_PER_REQUEST> data_blocks;
...
private:
	...
	public:
		...
		FixedArrayV<std::shared_ptr<VoxelBufferInternal>, VoxelConstants::MAX_BLOCK_COUNT_PER_REQUEST> blocks;
		// TODO Need to provide format
		//FixedArrayV<uint8_t, VoxelBufferInternal::MAX_CHANNELS> channel_depths;
