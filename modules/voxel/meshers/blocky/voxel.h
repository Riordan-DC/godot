...
public:
	...
	struct BakedData {
		struct Model {
			...
			FixedArrayV<std::vector<Vector3>, Cube::SIDE_COUNT> side_positions;
			FixedArrayV<std::vector<Vector2>, Cube::SIDE_COUNT> side_uvs;
			FixedArrayV<std::vector<int>, Cube::SIDE_COUNT> side_indices;
			FixedArrayV<std::vector<float>, Cube::SIDE_COUNT> side_tangents;

			FixedArrayV<uint32_t, Cube::SIDE_COUNT> side_pattern_indices;
...
private:
	...
	FixedArrayV<Vector2, Cube::SIDE_COUNT> _cube_tiles;
